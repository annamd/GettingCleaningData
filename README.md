The script run_analysis.R creates a tidy data set based on the data from http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones. 
